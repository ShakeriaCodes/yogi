# __________ Global Variables _______________
...
def handle_turn(player):
    ...
    while not valid:
        ...
        while position not in ["1", "2", "3", "4", "5", "6", "7", "8", "9"]:
            position = input("Please choose a position form 1-9: ")
...
def flip_player():
    ...
    if current_player == "X":
        current_player = "O"
        # if the current player was O , then change it to X6
